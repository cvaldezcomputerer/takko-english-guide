 ...
 * and caches them to scripts/image-candidates.json. Nothing is downloaded yet —
 ...
 *
 * Usage:
 *   node scripts/fetch-image-candidates.mjs
 *
...
const CACHE_PATH = join(__dirname, "image-candidates.json");
...
// ── main ──
const SELECTIONS_PATH = join(__dirname, "image-selections.json");
const arg = (name) => {
