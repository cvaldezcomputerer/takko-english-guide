const foodImages = import.meta.glob(
  "../assets/letter-game/food/*.{jpg,jpeg,png,webp,gif,svg}",
  { eager: true, query: "?url", import: "default" }
);

const animalsImages = import.meta.glob(
  "../assets/letter-game/animals/*.{jpg,jpeg,png,webp,gif,svg}",
  { eager: true, query: "?url", import: "default" }
);

const objectsImages = import.meta.glob(
  "../assets/letter-game/objects/*.{jpg,jpeg,png,webp,gif,svg}",
  { eager: true, query: "?url", import: "default" }
);
...
function generateNewPair() {
  ...
  const imagesToUse =
    availableImages.length >= 2 ? availableImages : categoryImages;
